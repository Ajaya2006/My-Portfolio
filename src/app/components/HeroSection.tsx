        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              ...
              >
                ...
                href="/Resume.pdf"
                download="Resume.pdf"
                className="px-8 py-3 border-2 border-[#FF8C00] text-[#FF8C00] rounded-lg font-semibold hover:bg-[#FF8C00] hover:text-white transition-all duration-300"
                >
                Download Resume
                </a>
            </div>
          ...
          >
            ...
            >
              ...
              {/* Bottom Vignette Fade (Hides Legs Smoothly) */}
